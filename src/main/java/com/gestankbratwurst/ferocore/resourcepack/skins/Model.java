...
public enum Model {
  ...
  DWARF_CANON(Material.STICK, 1139, false, true, false),
  HUMAN_CROWN(Material.STICK, 1140, false, true, false),
  DWARF_CROWN(Material.STICK, 1141, false, true, false),
  ELF_CROWN(Material.STICK, 1142, false, true, false),
  UNDEAD_CROWN(Material.STICK, 1143, false, true, false),
  CANON_BALL(Material.STICK, 1144, false, true, false),
  HEALING_FOUNTAIN(Material.STICK, 1145, false, true, false),
  ELF_ORB_MODEL(Material.STICK, 1146, false, true, false),
  UNDEAD_TOTEM(Material.STICK, 1147, false, true, false),
  ORC_HORN(Material.STICK, 1148, false, true, false),
  HOLY_CIRCLE(Material.STICK, 1149, false, true, false),
