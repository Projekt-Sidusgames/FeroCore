 ...
 *
 */
public class WoodenSpearPikeRecipe extends CustomShapedRecipe {

  public WoodenSpearPikeRecipe() {
    super("wooden_spear_pike", createItem());
    super.setShape("w", "w");
    super.setMaterialIngredients('w',
        Arrays.stream(Material.values()).filter(mat -> mat.toString().contains("PLANKS")).toArray(Material[]::new));
  }
  ...
  public static ItemStack createItem() {
    return new ItemBuilder(Model.WOODEN_SPEAR_PIKE.getItem()).name("§fHolz Speer Spitze").build();
  }
