 ...
 *
 */
public class IronSpearPikeRecipe extends CustomShapedRecipe {

  public IronSpearPikeRecipe() {
    super("iron_spear_pike", createItem());
    super.setShape("i", "i");
    super.setMaterialIngredients('i', Material.IRON_INGOT);
  }
  ...
  public static ItemStack createItem() {
    return new ItemBuilder(Model.IRON_SPEAR_PIKE.getItem()).name("§fEisen Speer Spitze").build();
  }
