 ...
 *
 */
public class WoodenSpearRecipe extends CustomShapedRecipe {

  public WoodenSpearRecipe() {
    super("wooden_spear", createItem());
    super.setShape("  p", " s ", "s  ");
    super.setMaterialIngredients('s', Material.STICK);
    super.setIngredient('p', WoodenSpearPikeRecipe.createItem());
  }
  ...
  public static ItemStack createItem() {
    return RoleModule.tagAsSpear(new ItemBuilder(Model.WOODEN_SPEAR.getItem()).name("§fHolz Speer").build());
  }
