 ...
 *
 */
public class StoneSpearRecipe extends CustomShapedRecipe {

  public StoneSpearRecipe() {
    super("stone_spear", createItem());
    super.setShape("  p", " s ", "s  ");
    super.setMaterialIngredients('s', Material.STICK);
    super.setIngredient('p', StoneSpearPikeRecipe.createItem());
  }
  ...
  public static ItemStack createItem() {
    return RoleModule.tagAsSpear(new ItemBuilder(Model.STONE_SPEAR.getItem()).name("§fStein Speer").build());
  }
