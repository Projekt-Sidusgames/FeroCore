 ...
 *
 */
public class NetheriteSpearRecipe extends CustomShapedRecipe {

  public NetheriteSpearRecipe() {
    super("netherite_spear", createItem());
    super.setShape("  p", " s ", "s  ");
    super.setMaterialIngredients('s', Material.STICK);
    super.setIngredient('p', NetheriteSpearPikeRecipe.createItem());
  }
  ...
  public static ItemStack createItem() {
    return RoleModule.tagAsSpear(new ItemBuilder(Model.NETHERITE_SPEAR.getItem()).name("§fNetherite Speer").build());
  }
