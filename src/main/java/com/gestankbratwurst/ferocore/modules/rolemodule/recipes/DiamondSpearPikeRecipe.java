 ...
 *
 */
public class DiamondSpearPikeRecipe extends CustomShapedRecipe {

  public DiamondSpearPikeRecipe() {
    super("diamond_spear_pike", createItem());
    super.setShape("d", "d");
    super.setMaterialIngredients('d', Material.DIAMOND);
  }
  ...
  public static ItemStack createItem() {
    return new ItemBuilder(Model.DIAMOND_SPEAR_PIKE.getItem()).name("§fDiamant Speer Spitze").build();
  }
